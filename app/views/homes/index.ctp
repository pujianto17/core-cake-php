<center><h2><?php echo __('List Data'); ?></h2></center>
<div class="actions">
	<ul>
		<li class="user_add"><?php echo $html->link(__('Upload Data', true), array('action'=>'add')); ?></li>
	</ul>
</div><br>
...
<div>
    ...
    <?php
	  echo $html->tableHeaders(array(
                                      'No',
                                      $paginator->sort('Nama / Judul peta'),
                                      $paginator->sort('Nama PT'),
                                      $paginator->sort('Tujuan'),
                                      $paginator->sort('Tgl buat'),
                                      $paginator->sort('Pembuat'),
									  $paginator->sort('File'),
                                      //__('Actions', true),
                                     ));
        $rows = array();
