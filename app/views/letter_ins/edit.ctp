	...
	<table class="input">
            <tr>
				...
				<td><?php
						...
						echo $form->input('letter_no', array('div'=>false, 'label' => false, 'maxlength' => 50, 'class'=>'required'));
					?>
				</td>
            </tr>
            <tr>
            ...
            <!--tr>
                ...
                <td><?php //echo $form->select('unit_code_id', $unit_codes, null, array('div'=>false, 'label' => false));?></td>
            </tr-->
            <tr>
                <td colspan="2">
                <?php
